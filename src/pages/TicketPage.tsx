    ...
    return (
        <div className="max-w-2xl mx-auto py-12 px-6">
            ...
            <div className="text-center mb-10">
                <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-6 bg-green-100 dark:bg-green-900/30 text-green-500 dark:text-green-400 animate-bounce shadow-lg shadow-green-500/20`}>
            ...
            {/* Ticket Card */}
            <div ref={ticketRef} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-lg overflow-hidden relative">
                {/* Decorative Header */}
                ...
                <div className="w-full flex items-center relative -mt-px">
                    <div className="w-6 h-6 bg-slate-50 dark:bg-slate-950 rounded-full -ml-3 z-10" />
                    <div className="flex-1 border-t-2 border-dashed border-slate-200 dark:border-slate-800" />
                    <div className="w-6 h-6 bg-slate-50 dark:bg-slate-950 rounded-full -mr-3 z-10" />
                </div>
                ...
                <div className="p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50/50 dark:bg-slate-800/40 rounded-xl p-6 border border-slate-100 dark:border-slate-800 mb-6">
                        <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <button onClick={onHome} className="flex-1 py-4 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold rounded-xl transition-colors flex items-center justify-center gap-2">
